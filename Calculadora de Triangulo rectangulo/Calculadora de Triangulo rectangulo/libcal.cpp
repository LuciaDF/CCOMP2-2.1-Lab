//
//  libcal.cpp
//  Calculadora de Triangulo rectangulo
//
//  Created by Jorge Dueñas on 5/17/20.
...
{
    if (b>c and b>a and b!=0){//caso que b es la hipotenusa
...
{
    if (c>a and c>b and c!=0){//caso que c es la hipotenusa
